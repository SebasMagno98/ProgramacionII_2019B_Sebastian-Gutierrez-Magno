; Listing generated by Microsoft (R) Optimizing Compiler Version 19.15.26730.0 
	...
	TITLE	C:\Users\PC\source\repos\Project1\Project1\Prueba.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	??_C@_0N@FCCEBCPC@Hola?5Mundo?4?6@		; `string'
EXTRN	_strlen:PROC
...
rtc$IMZ	ENDS
;	COMDAT ??_C@_0N@FCCEBCPC@Hola?5Mundo?4?6@
CONST	SEGMENT
??_C@_0N@FCCEBCPC@Hola?5Mundo?4?6@ DB 'Hola Mundo.', 0aH, 00H ; `string'
CONST	ENDS
;	COMDAT xdata$x
xdata$x	SEGMENT
...
_TEXT	SEGMENT
_main	PROC						; COMDAT
; File c:\users\pc\source\repos\project1\project1\prueba.cpp
; Line 4
	push	ebp
	mov	ebp, esp
	...
	mov	eax, -858993460				; ccccccccH
	rep stosd
	mov	ecx, OFFSET __39B0AF01_prueba@cpp
	call	@__CheckForDebuggerJustMyCode@4
; Line 5
	push	OFFSET ??_C@_0N@FCCEBCPC@Hola?5Mundo?4?6@
